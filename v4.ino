...
int angulos(float resultado) {
    if(quadrante == 0){
      ...
      Serial.print("Quadrante 0, Angulo ");
      Serial.println(angulo);
      return angulo;
    }else if(quadrante == 3){
      float angulo = (resultado * 90) + 270;
      Serial.print("Quadrante 3, Angulo ");  
      Serial.println(angulo);
      return angulo;
    }
    else if(quadrante == 1){
      float angulo = (resultado * 90) + 90;
      Serial.print("Quadrante 1, Angulo ");
      Serial.println(angulo);
      return angulo;
    }else if(quadrante == 2){
      float angulo = (resultado * 90) + 180;
      Serial.print("Quadrante 2, Angulo ");
      Serial.println(angulo);
      return angulo;
    }
}
...
void verificar_posicao(){
  ...
  float resultado_leste_norte = float(abs(valor_sensor_leste-valor_medio_leste)) / (abs(valor_sensor_norte-valor_medio_norte));
  float resultado_leste_sul = float(abs(valor_sensor_oeste-valor_medio_oeste)) / (abs(valor_sensor_leste-valor_medio_leste));
  ...
  if(contador > 3000 and ((valor_sensor_leste > valor_medio_leste+sensibilidade) || (valor_sensor_norte > valor_medio_norte+sensibilidade) || (valor_sensor_oeste > valor_medio_oeste+sensibilidade) || (valor_sensor_sul > valor_medio_sul+sensibilidade))){
    ...
    if(abs(valor_sensor_norte-valor_medio_norte) > abs(valor_sensor_sul-valor_medio_sul)){ //Norte > Sul
      if(abs(valor_sensor_leste-valor_medio_leste) > abs(valor_sensor_oeste-valor_medio_oeste)){
      ...
      }else if(abs(valor_sensor_leste-valor_medio_leste) < abs(valor_sensor_oeste-valor_medio_oeste)){
        //direção oeste-norte
        quadrante = 1;
        ...
        ///////////////////////////////////////////////////////////
        if(valor_sensor_leste-valor_medio_leste == 0){     
          float resultado_oeste_norte = float(abs(valor_sensor_oeste-valor_medio_oeste)) / (abs(valor_sensor_norte-valor_medio_norte));
          float resultado_norte_oeste = float(abs(valor_sensor_norte-valor_medio_norte)) / (abs(valor_sensor_oeste-valor_medio_oeste));
          if(abs(valor_sensor_oeste-valor_medio_oeste) > abs(valor_sensor_norte-valor_medio_norte)){ //Oeste > Norte
           if(resultado_norte_oeste < 0.1){
              // bluetooth.println("Leste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Oeste");
            }else if(resultado_norte_oeste >= 0.1 and resultado_norte_oeste <= 0.675){
              //bluetooth.println("Nordeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Noroeste"); 
            }else{
              //bluetooth.println("Norte"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            //float retorno = angulos(resultado_norte_leste);
            float angulo = 180 - (resultado_norte_oeste * 90);
            Serial.println(angulo);
            ...
            if(resultado_oeste_norte < 0.1){
              // bluetooth.println("Norte"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Norte");
            }else if(resultado_oeste_norte >= 0.1 and resultado_oeste_norte <= 0.675){
              //bluetooth.println("Nordeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Noroeste"); 
            }else{
              //bluetooth.println("Leste"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            float angulo = 90 + (resultado_oeste_norte * 90);
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
        ...
        ////////////////////////////////////////////////////////////////////////
        if(valor_sensor_oeste-valor_medio_oeste == 0){
         
          float resultado_leste_norte = float(abs(valor_sensor_leste-valor_medio_leste)) / (abs(valor_sensor_norte-valor_medio_norte));
          float resultado_norte_leste = float(abs(valor_sensor_norte-valor_medio_norte)) / (abs(valor_sensor_leste-valor_medio_leste));
          if(abs(valor_sensor_leste-valor_medio_leste) > abs(valor_sensor_norte-valor_medio_norte)){ //Leste > Norte
           if(resultado_norte_leste < 0.1){
              // bluetooth.println("Leste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Leste");
            }else if(resultado_norte_leste >= 0.1 and resultado_norte_leste <= 0.675){
              //bluetooth.println("Nordeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Nordeste"); 
            }else{
              //bluetooth.println("Norte"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            //float retorno = angulos(resultado_norte_leste);
            float angulo = resultado_norte_leste * 90;
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
            ...
            if(resultado_leste_norte < 0.1){
              // bluetooth.println("Norte"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Norte");
            }else if(resultado_leste_norte >= 0.1 and resultado_leste_norte <= 0.675){
              //bluetooth.println("Nordeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Nordeste"); 
            }else{
              //bluetooth.println("Leste"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            float angulo = 90 - (resultado_leste_norte * 90);
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
        ...
        if(valor_sensor_leste-valor_medio_leste == valor_sensor_oeste-valor_medio_oeste){
          Serial.println("Norte");
          Serial.println("90");
      ...
      if(abs(valor_sensor_leste-valor_medio_leste) > abs(valor_sensor_oeste-valor_medio_oeste)){
        ...
        ///////////////////////////////////////////////////////////
        if(valor_sensor_leste-valor_medio_leste == 0){     
          float resultado_oeste_sul = float(abs(valor_sensor_oeste-valor_medio_oeste)) / (abs(valor_sensor_sul-valor_medio_sul));
          float resultado_sul_oeste = float(abs(valor_sensor_sul-valor_medio_sul)) / (abs(valor_sensor_oeste-valor_medio_oeste));
          if(abs(valor_sensor_oeste-valor_medio_oeste) > abs(valor_sensor_sul-valor_medio_sul)){ //Oeste > Sul
           if(resultado_sul_oeste < 0.1){
              // bluetooth.println("Oeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Oeste");
            }else if(resultado_sul_oeste >= 0.1 and resultado_sul_oeste <= 0.675){
              //bluetooth.println("Sudoeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sudoeste"); 
            }else{
              //bluetooth.println("Sul"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            //float retorno = angulos(resultado_norte_leste);
            float angulo = 180 + (resultado_sul_oeste * 90);
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
          }else{ // Sul > Oeste
            if(resultado_oeste_sul < 0.1){
              // bluetooth.println("Sul"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sul");
            }else if(resultado_oeste_sul >= 0.1 and resultado_oeste_sul <= 0.675){
              //bluetooth.println("Sudoeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sudoeste"); 
            }else{
              //bluetooth.println("Oeste"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            float angulo = 270 - (resultado_oeste_sul * 90);
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
        ...
        ////////////////////////////////////////////////////////////////////////
        if(valor_sensor_oeste-valor_medio_oeste == 0){ //Trabalhando com o Leste
         
          float resultado_leste_sul = float(abs(valor_sensor_leste-valor_medio_leste)) / (abs(valor_sensor_sul-valor_medio_sul));
          float resultado_sul_leste = float(abs(valor_sensor_sul-valor_medio_sul)) / (abs(valor_sensor_leste-valor_medio_leste));
          if(abs(valor_sensor_leste-valor_medio_leste) > abs(valor_sensor_sul-valor_medio_sul)){ //Leste > Sul
           if(resultado_sul_leste < 0.1){
              // bluetooth.println("Leste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Leste");
            }else if(resultado_sul_leste >= 0.1 and resultado_sul_leste <= 0.675){
              //bluetooth.println("Sudeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sudeste"); 
            }else{
              //bluetooth.println("Sul"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sul");    
            ...
            //float retorno = angulos(resultado_norte_leste);
            float angulo = 360 - (resultado_sul_leste * 90);
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
          }else{ // Sul > Leste
            if(resultado_leste_sul < 0.1){
              // bluetooth.println("Sul"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sul");
            }else if(resultado_leste_sul >= 0.1 and resultado_leste_sul <= 0.675){
              //bluetooth.println("Sudeste"); // Envia a string "Ola Mundo"via Bluetooth
              Serial.println("Sudeste"); 
            }else{
              //bluetooth.println("Leste"); // Envia a string "Ola Mundo"via Bluetooth
            ...
            float angulo = 270 + (resultado_leste_sul * 90);
            Serial.println(angulo);
            bluetooth.println(angulo);
            delay(1000);
            return;
...
void loop() {
    ...
    valores[0].direcao = 0;
    valores[0].valor_sensor = valor_sensor_leste;
    valores[1].direcao = 0;
    valores[1].valor_sensor = valor_sensor_norte;
    valores[2].direcao = 0;
    valores[2].valor_sensor = valor_sensor_oeste;
    valores[3].direcao = 0;
    valores[3].valor_sensor = valor_sensor_sul;
